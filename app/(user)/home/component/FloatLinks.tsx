...
export default function FloatLinks({openLinks}:{openLinks:boolean}) {
    ...
    return (
        <div className={`${openLinks?'opacity-1 scale-100':'opacity-0 -order-5 scale-0 -translate-y-52 '} absolute top-[80px] left-[50%] ${i18n.language == 'en'?'translate-x-[-40%]':'translate-x-[-60%]'}  bg-black p-5 text-white w-[350px] rounded-lg transition-all duration-700 z-10`}>
