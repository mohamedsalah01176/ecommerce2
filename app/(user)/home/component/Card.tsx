  ...
  return (
    ...
    {data.map((item:item,index:number)=>
        ...
        <div className='px-4 pt-2 '>
            ...
            <button onClick={()=>{token?handleQuantityChange(item.id,1):nav.push('/register');setClick(true)}}  className='py-2 px-4 bg-gray-700 hover:bg-black rounded-lg transition2 text-white  w-fit mx-auto absolute  left-[50%] translate-x-[-50%]  '>{t("ADD TO CART")}</button>
    </div>
