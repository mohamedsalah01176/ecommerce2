...
export default function LoaderShowItem() {
  return (
    <div
  className="p-4  rounded shadow animate-pulse md:p-6  md:flex w-full  gap-7"
>
  <div
    className="flex items-center justify-center mb-4 bg-gray-300 rounded dark:bg-gray-300 w-full lg:w-1/2 text-center "
  >
    <svg
      viewBox="0 0 16 20"
      fill="currentColor"
      ...
      aria-hidden="true"
      className=" text-gray-200 dark:text-gray-400 h-[450px] min-w-[250px]"
    >
      <path
