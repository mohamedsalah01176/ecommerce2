  ...
  return (
    <div className='bg-black min-h-screen flex flex-col  justify-center items-center'>
        <form action="" onSubmit={handleRegister} className='flex flex-col w-[300px] gap-5 items-center -translate-y-7 '>
            ...
            <select name="userType" id="userType" className='p-3 text-black font-light border-none outline-none rounded-3xl w-full' onChange={(e:any)=>setTypeUser(e.target.value)} >
